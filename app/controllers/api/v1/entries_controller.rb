...
class Api::V1::EntriesController < ApplicationController
  ...
  def create
    ...
    render json: entry.errors, status: :unprocessable_entity and return unless entry.save

    bookmark = entry.bookmarks.find_or_initialize_by(user_id: current_api_v1_user.id)
    render json: bookmark.errors, status: :unprocessable_entity and return unless bookmark.save
